...
import com.chavesgu.images_picker.lib.broadcast.BroadcastAction;
import com.chavesgu.images_picker.lib.broadcast.BroadcastManager;
...
import com.chavesgu.images_picker.lib.listener.OnImageCompleteCallback;
...
import com.chavesgu.images_picker.lib.widget.longimage.ImageSource;
import com.chavesgu.images_picker.lib.widget.longimage.ImageViewState;
...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    public int getResourceId() {
        return com.chavesgu.images_picker.R.layout.picture_activity_external_preview;
    }
    ...
    protected void initWidgets() {
        ...
        ibLeftBack = findViewById(com.chavesgu.images_picker.R.id.left_back);
        ibDelete = findViewById(com.chavesgu.images_picker.R.id.ib_delete);
    ...
    public void initPictureSelectorStyle() {
        if (PictureSelectionConfig.style != null) {
            ...
            int previewBgColor = AttrsUtils.getTypeValueColor(getContext(), com.chavesgu.images_picker.R.attr.picture_ac_preview_title_bg);
            if (previewBgColor != 0) {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == com.chavesgu.images_picker.R.id.left_back) {
            finish();
            exitAnimation();
        } else if (id == com.chavesgu.images_picker.R.id.ib_delete) {
            if (images.size() > 0) {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (contentView == null) {
                contentView = LayoutInflater.from(container.getContext())
                        .inflate(com.chavesgu.images_picker.R.layout.picture_image_preview, container, false);
                mCacheView.put(position, contentView);
            }
            // 常规图控件
            final PhotoView photoView = contentView.findViewById(com.chavesgu.images_picker.R.id.preview_image);
            // 长图控件
            final SubsamplingScaleImageView longImageView = contentView.findViewById(com.chavesgu.images_picker.R.id.longImg);
            // 视频播放按钮
            ImageView ivPlay = contentView.findViewById(com.chavesgu.images_picker.R.id.iv_play);
    ...
    private void showDownLoadDialog() {
        if (!isFinishing() && !TextUtils.isEmpty(downloadPath)) {
            final PictureCustomDialog dialog =
                    new PictureCustomDialog(getContext(), com.chavesgu.images_picker.R.layout.picture_wind_base_dialog);
            ...
            tv_content.setText(getString(com.chavesgu.images_picker.R.string.picture_prompt_content));
    ...
    private void onSuccessful(String filePath) {
        if (TextUtils.isEmpty(filePath)) {
            ToastUtils.s(getContext(), getString(com.chavesgu.images_picker.R.string.picture_save_error));
        } else {
            new PictureMediaScannerConnection(getContext(), filePath, null);
            ToastUtils.s(getContext(), getString(com.chavesgu.images_picker.R.string.picture_save_success) + "\n" + filePath);
        }
    }
    ...
    private void exitAnimation() {
        overridePendingTransition(com.chavesgu.images_picker.R.anim.picture_anim_fade_in, PictureSelectionConfig.windowAnimationStyle.activityPreviewExitAnimation);
    }
        ...
        if (requestCode == PictureConfig.APPLY_STORAGE_PERMISSIONS_CODE) {// 存储权限
            for (int grantResult : grantResults) {
                if (grantResult == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ToastUtils.s(getContext(), getString(com.chavesgu.images_picker.R.string.picture_jurisdiction));
                }
            }
        }
    }
