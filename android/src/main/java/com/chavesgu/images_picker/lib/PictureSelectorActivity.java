...
import com.chavesgu.images_picker.lib.adapter.PictureImageGridAdapter;
import com.chavesgu.images_picker.lib.animators.AlphaInAnimationAdapter;
import com.chavesgu.images_picker.lib.animators.AnimationType;
import com.chavesgu.images_picker.lib.animators.SlideInBottomAnimationAdapter;
...
import com.chavesgu.images_picker.lib.decoration.GridSpacingItemDecoration;
import com.chavesgu.images_picker.lib.dialog.PhotoItemSelectedDialog;
import com.chavesgu.images_picker.lib.dialog.PictureCustomDialog;
import com.chavesgu.images_picker.lib.entity.LocalMedia;
import com.chavesgu.images_picker.lib.entity.LocalMediaFolder;
import com.chavesgu.images_picker.lib.entity.MediaExtraInfo;
import com.chavesgu.images_picker.lib.listener.OnAlbumItemClickListener;
import com.chavesgu.images_picker.lib.listener.OnItemClickListener;
import com.chavesgu.images_picker.lib.listener.OnPermissionDialogOptionCallback;
import com.chavesgu.images_picker.lib.listener.OnPhotoSelectChangedListener;
import com.chavesgu.images_picker.lib.listener.OnQueryDataResultListener;
import com.chavesgu.images_picker.lib.listener.OnRecyclerViewPreloadMoreListener;
import com.chavesgu.images_picker.lib.manager.UCropManager;
import com.chavesgu.images_picker.lib.observable.ImagesObservable;
import com.chavesgu.images_picker.lib.permissions.PermissionChecker;
import com.chavesgu.images_picker.lib.tools.AlbumUtils;
import com.chavesgu.images_picker.lib.tools.AttrsUtils;
import com.chavesgu.images_picker.lib.tools.BitmapUtils;
import com.chavesgu.images_picker.lib.tools.CameraFileUtils;
import com.chavesgu.images_picker.lib.tools.DateUtils;
import com.chavesgu.images_picker.lib.tools.DoubleUtils;
import com.chavesgu.images_picker.lib.tools.JumpUtils;
import com.chavesgu.images_picker.lib.tools.MediaUtils;
import com.chavesgu.images_picker.lib.tools.PictureFileUtils;
import com.chavesgu.images_picker.lib.tools.ScreenUtils;
import com.chavesgu.images_picker.lib.tools.SdkVersionUtils;
import com.chavesgu.images_picker.lib.tools.SortUtils;
import com.chavesgu.images_picker.lib.tools.StringUtils;
import com.chavesgu.images_picker.lib.tools.ToastUtils;
import com.chavesgu.images_picker.lib.tools.ValueOf;
import com.chavesgu.images_picker.lib.widget.FolderPopWindow;
import com.chavesgu.images_picker.lib.widget.RecyclerPreloadView;
import com.chavesgu.images_picker.ucrop.UCrop;
...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    public int getResourceId() {
        return com.chavesgu.images_picker.R.layout.picture_selector;
    }

    @Override
    protected void initWidgets() {
        super.initWidgets();
        container = findViewById(com.chavesgu.images_picker.R.id.container);
        mTitleBar = findViewById(com.chavesgu.images_picker.R.id.titleBar);
        mIvPictureLeftBack = findViewById(com.chavesgu.images_picker.R.id.pictureLeftBack);
        mTvPictureTitle = findViewById(com.chavesgu.images_picker.R.id.picture_title);
        mTvPictureRight = findViewById(com.chavesgu.images_picker.R.id.picture_right);
        mTvPictureOk = findViewById(com.chavesgu.images_picker.R.id.picture_tv_ok);
        mCbOriginal = findViewById(com.chavesgu.images_picker.R.id.cb_original);
        mIvArrow = findViewById(com.chavesgu.images_picker.R.id.ivArrow);
        viewClickMask = findViewById(com.chavesgu.images_picker.R.id.viewClickMask);
        mTvPicturePreview = findViewById(com.chavesgu.images_picker.R.id.picture_id_preview);
        mTvPictureImgNum = findViewById(com.chavesgu.images_picker.R.id.tv_media_num);
        mRecyclerView = findViewById(com.chavesgu.images_picker.R.id.picture_recycler);
        mBottomLayout = findViewById(com.chavesgu.images_picker.R.id.select_bar_layout);
        mTvEmpty = findViewById(com.chavesgu.images_picker.R.id.tv_empty);
        isNumComplete(numComplete);
        if (!numComplete) {
            animation = AnimationUtils.loadAnimation(this, com.chavesgu.images_picker.R.anim.picture_anim_modal_in);
        }
        ...
        mTvEmpty.setText(config.chooseMode == PictureMimeType.ofAudio() ?
                getString(com.chavesgu.images_picker.R.string.picture_audio_empty)
                : getString(com.chavesgu.images_picker.R.string.picture_empty));
    ...
    private void setTitle(String title) {
        if (TextUtils.isEmpty(title)) {
            String defaultTitle = config.chooseMode == PictureMimeType.ofAudio() ?
                    getString(com.chavesgu.images_picker.R.string.picture_all_audio) : getString(com.chavesgu.images_picker.R.string.picture_camera_roll);
            mTvPictureTitle.setText(defaultTitle);
        } else {
            mTvPictureTitle.setText(title);
        }
        mTvPictureTitle.setTag(com.chavesgu.images_picker.R.id.view_tag, -1);
    }
    ...
    private int getPageLimit() {
        int bucketId = ValueOf.toInt(mTvPictureTitle.getTag(com.chavesgu.images_picker.R.id.view_tag));
        if (bucketId == -1) {
    ...
    private void loadMoreData() {
        if (mAdapter != null) {
            if (isHasMore) {
                mPage++;
                long bucketId = ValueOf.toLong(mTvPictureTitle.getTag(com.chavesgu.images_picker.R.id.view_tag));
                        ...
                        new OnQueryDataResultListener<LocalMedia>(){
                            ...
                            public void onComplete(List<LocalMedia> result, int currentPage, boolean isHasMore) {
                                ...
                                if (isHasMore) {
                                    ...
                                    if (isEmpty) {
                                        showDataNull(bucketId == -1 ? getString(com.chavesgu.images_picker.R.string.picture_empty) : getString(com.chavesgu.images_picker.R.string.picture_data_null), com.chavesgu.images_picker.R.drawable.picture_icon_no_data);
                                    }
                                }
                            }
                        });
        ...
        if (PictureSelectionConfig.uiStyle != null) {
            ...
            if (config.isOriginalControl) {
                if (PictureSelectionConfig.uiStyle.picture_bottom_originalPictureCheckStyle != 0) {
                    ...
                    mCbOriginal.setButtonDrawable(ContextCompat.getDrawable(this, com.chavesgu.images_picker.R.drawable.picture_original_checkbox));
                }
                if (PictureSelectionConfig.uiStyle.picture_bottom_originalPictureTextColor != 0) {
                    ...
                    mCbOriginal.setTextColor(ContextCompat.getColor(this, com.chavesgu.images_picker.R.color.picture_color_white));
                }
            ...
            int titleColor = AttrsUtils.getTypeValueColor(getContext(), com.chavesgu.images_picker.R.attr.picture_title_textColor);
            if (titleColor != 0) {
                mTvPictureTitle.setTextColor(titleColor);
            }
            int rightTitleColor = AttrsUtils.getTypeValueColor(getContext(), com.chavesgu.images_picker.R.attr.picture_right_textColor);
            if (rightTitleColor != 0) {
                mTvPictureRight.setTextColor(rightTitleColor);
            }
            int containerBackgroundColor = AttrsUtils.getTypeValueColor(getContext(), com.chavesgu.images_picker.R.attr.picture_container_backgroundColor);
            if (containerBackgroundColor != 0) {
                container.setBackgroundColor(containerBackgroundColor);
            }
            Drawable leftDrawable = AttrsUtils.getTypeValueDrawable(getContext(), com.chavesgu.images_picker.R.attr.picture_leftBack_icon, com.chavesgu.images_picker.R.drawable.picture_icon_back);
            ...
            if (config.downResId != 0) {
                ...
                Drawable downDrawable = AttrsUtils.getTypeValueDrawable(getContext(), com.chavesgu.images_picker.R.attr.picture_arrow_down_icon, com.chavesgu.images_picker.R.drawable.picture_icon_arrow_down);
                mIvArrow.setImageDrawable(downDrawable);
            }
            int pictureBottomBgColor = AttrsUtils.getTypeValueColor(getContext(), com.chavesgu.images_picker.R.attr.picture_bottom_bg);
            if (pictureBottomBgColor != 0) {
                mBottomLayout.setBackgroundColor(pictureBottomBgColor);
            }
            ColorStateList completeColorStateList = AttrsUtils.getTypeValueColorStateList(getContext(), com.chavesgu.images_picker.R.attr.picture_complete_textColor);
            if (completeColorStateList != null) {
                mTvPictureOk.setTextColor(completeColorStateList);
            }
            ColorStateList previewColorStateList = AttrsUtils.getTypeValueColorStateList(getContext(), com.chavesgu.images_picker.R.attr.picture_preview_textColor);
            if (previewColorStateList != null) {
                mTvPicturePreview.setTextColor(previewColorStateList);
            }
            int pictureTitleRightArrowLeftPadding = AttrsUtils.getTypeValueSizeForInt(getContext(), com.chavesgu.images_picker.R.attr.picture_titleRightArrow_LeftPadding);
            if (pictureTitleRightArrowLeftPadding != 0) {
                RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mIvArrow.getLayoutParams();
                params.leftMargin = pictureTitleRightArrowLeftPadding;
            }
            Drawable ovalBgDrawable = AttrsUtils.getTypeValueDrawable(getContext(), com.chavesgu.images_picker.R.attr.picture_num_style, com.chavesgu.images_picker.R.drawable.picture_num_oval);
            mTvPictureImgNum.setBackground(ovalBgDrawable);

            int titleBarHeight = AttrsUtils.getTypeValueSizeForInt(getContext(), com.chavesgu.images_picker.R.attr.picture_titleBar_height);
            if (titleBarHeight > 0) {
                ViewGroup.LayoutParams params = mTitleBar.getLayoutParams();
                params.height = titleBarHeight;
            }
            if (config.isOriginalControl) {
                Drawable originalDrawable = AttrsUtils.getTypeValueDrawable(getContext(), com.chavesgu.images_picker.R.attr.picture_original_check_style, com.chavesgu.images_picker.R.drawable.picture_original_wechat_checkbox);
                mCbOriginal.setButtonDrawable(originalDrawable);
                int originalTextColor = AttrsUtils.getTypeValueColor(getContext(), com.chavesgu.images_picker.R.attr.picture_original_text_color);
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    if (PictureSelectionConfig.uiStyle.isCompleteReplaceNum) {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText != 0
                                ? String.format(getString(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText), startCount, 1) : getString(com.chavesgu.images_picker.R.string.picture_please_select));
                    } else {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText != 0
                                ? getString(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText) : getString(com.chavesgu.images_picker.R.string.picture_please_select));
                    }
                } else if (PictureSelectionConfig.style != null) {
                    if (PictureSelectionConfig.style.isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)) {
                        ...
                        mTvPictureOk.setText(!TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                                ? PictureSelectionConfig.style.pictureUnCompleteText : getString(com.chavesgu.images_picker.R.string.picture_done));
                    }
                }
            } else {
                if (PictureSelectionConfig.uiStyle != null) {
                    if (PictureSelectionConfig.uiStyle.isCompleteReplaceNum) {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText != 0
                                ? String.format(getString(PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText), startCount, 1) : getString(com.chavesgu.images_picker.R.string.picture_done));
                    } else {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText != 0
                                ? getString(PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText) : getString(com.chavesgu.images_picker.R.string.picture_done));
                    }
                } else if (PictureSelectionConfig.style != null) {
                    if (PictureSelectionConfig.style.isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)) {
                        ...
                        mTvPictureOk.setText(!TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)
                                ? PictureSelectionConfig.style.pictureCompleteText : getString(com.chavesgu.images_picker.R.string.picture_done));
                    }
                }
            }
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    if (PictureSelectionConfig.uiStyle.isCompleteReplaceNum) {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText != 0
                                ...
                                getString(com.chavesgu.images_picker.R.string.picture_done_front_num, startCount, config.maxSelectNum));
                    } else {
                        mTvPictureOk.setText(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText != 0
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    ...
                    if (PictureSelectionConfig.uiStyle.isCompleteReplaceNum) {
                        if (PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText != 0) {
                            ...
                            mTvPictureOk.setText(getString(com.chavesgu.images_picker.R.string.picture_done_front_num, startCount, config.maxSelectNum));
                        }
                    } else {
                        if (PictureSelectionConfig.uiStyle.picture_bottom_completeNormalText != 0) {
    ...
    private void initPageModel(List<LocalMediaFolder> folders) {
        ...
        mTvPictureTitle.setTag(com.chavesgu.images_picker.R.id.view_count_tag, firstFolder != null ? firstFolder.getImageNum() : 0);
        mTvPictureTitle.setTag(com.chavesgu.images_picker.R.id.view_index_tag, 0);
        ...
        mLoader.loadPageMediaData(bucketId, mPage, new OnQueryDataResultListener<LocalMedia>(){
                    ...
                    public void onComplete(List<LocalMedia> result, int currentPage, boolean isHasMore) {
                        ...
                        if (mAdapter != null) {
                            ...
                            boolean isEmpty = mAdapter.isDataEmpty();
                            if (isEmpty) {
                                showDataNull(getString(com.chavesgu.images_picker.R.string.picture_empty), com.chavesgu.images_picker.R.drawable.picture_icon_no_data);
                            } else {
                                hideDataNull();
                            }
    ...
    private void initAllModel(List<LocalMediaFolder> folders) {
        if (folders != null) {
            if (folders.size() > 0) {
                ...
                mTvPictureTitle.setTag(com.chavesgu.images_picker.R.id.view_count_tag, folder.getImageNum());
            ...
            showDataNull(getString(com.chavesgu.images_picker.R.string.picture_data_exception), com.chavesgu.images_picker.R.drawable.picture_icon_data_error);
        }
        dismissDialog();
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == com.chavesgu.images_picker.R.id.pictureLeftBack
                || id == com.chavesgu.images_picker.R.id.picture_right) {
        ...
        if (id == com.chavesgu.images_picker.R.id.picture_title || id == com.chavesgu.images_picker.R.id.ivArrow || id == com.chavesgu.images_picker.R.id.viewClickMask) {
            if (config.isOnlySandboxDir) {
                return;
            }
        ...
        if (id == com.chavesgu.images_picker.R.id.picture_id_preview) {
            onPreview();
            return;
        }

        if (id == com.chavesgu.images_picker.R.id.picture_tv_ok || id == com.chavesgu.images_picker.R.id.tv_media_num) {
            onComplete();
            return;
        }

        if (id == com.chavesgu.images_picker.R.id.titleBar) {
            if (config.isAutomaticTitleRecyclerTop) {
    ...
    private void onPreview() {
        ...
        overridePendingTransition(PictureSelectionConfig.windowAnimationStyle.activityPreviewEnterAnimation,
                com.chavesgu.images_picker.R.anim.picture_anim_fade_in);
    }
        ...
        if (config.isWithVideoImage) {
            ...
            if (config.selectionMode == PictureConfig.MULTIPLE) {
                if (config.minSelectNum > 0) {
                    if (imageSize < config.minSelectNum) {
                        showPromptDialog(getString(com.chavesgu.images_picker.R.string.picture_min_img_num, config.minSelectNum));
                        return;
                    }
                }
                if (config.minVideoSelectNum > 0) {
                    if (videoSize < config.minVideoSelectNum) {
                        showPromptDialog(getString(com.chavesgu.images_picker.R.string.picture_min_video_num, config.minVideoSelectNum));
                        return;
                    }
                }
            }
            ...
            if (config.selectionMode == PictureConfig.MULTIPLE) {
                if (PictureMimeType.isHasImage(mimeType) && config.minSelectNum > 0 && size < config.minSelectNum) {
                    String str = getString(com.chavesgu.images_picker.R.string.picture_min_img_num, config.minSelectNum);
                    showPromptDialog(str);
                    return;
                }
                if (PictureMimeType.isHasVideo(mimeType) && config.minVideoSelectNum > 0 && size < config.minVideoSelectNum) {
                    String str = getString(com.chavesgu.images_picker.R.string.picture_min_video_num, config.minVideoSelectNum);
                    showPromptDialog(str);
                    return;
                }
            }
    ...
    private void startPlayAudioDialog(final String path) {
        ...
        audioDialog = new PictureCustomDialog(getContext(), com.chavesgu.images_picker.R.layout.picture_audio_dialog);
        audioDialog.getWindow().setWindowAnimations(com.chavesgu.images_picker.R.style.Picture_Theme_Dialog_AudioStyle);
        mTvMusicStatus = audioDialog.findViewById(com.chavesgu.images_picker.R.id.tv_musicStatus);
        mTvMusicTime = audioDialog.findViewById(com.chavesgu.images_picker.R.id.tv_musicTime);
        musicSeekBar = audioDialog.findViewById(com.chavesgu.images_picker.R.id.musicSeekBar);
        mTvMusicTotal = audioDialog.findViewById(com.chavesgu.images_picker.R.id.tv_musicTotal);
        mTvPlayPause = audioDialog.findViewById(com.chavesgu.images_picker.R.id.tv_PlayPause);
        mTvStop = audioDialog.findViewById(com.chavesgu.images_picker.R.id.tv_Stop);
        mTvQuit = audioDialog.findViewById(com.chavesgu.images_picker.R.id.tv_Quit);
    ...
    public class onAudioOnClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            int id = v.getId();
            if (id == com.chavesgu.images_picker.R.id.tv_PlayPause) {
                playAudio();
            }
            if (id == com.chavesgu.images_picker.R.id.tv_Stop) {
                mTvMusicStatus.setText(getString(com.chavesgu.images_picker.R.string.picture_stop_audio));
                mTvPlayPause.setText(getString(com.chavesgu.images_picker.R.string.picture_play_audio));
                stop(path);
            }
            if (id == com.chavesgu.images_picker.R.id.tv_Quit) {
    ...
    private void playAudio() {
        ...
        if (ppStr.equals(getString(com.chavesgu.images_picker.R.string.picture_play_audio))) {
            mTvPlayPause.setText(getString(com.chavesgu.images_picker.R.string.picture_pause_audio));
            mTvMusicStatus.setText(getString(com.chavesgu.images_picker.R.string.picture_play_audio));
        } else {
            mTvPlayPause.setText(getString(com.chavesgu.images_picker.R.string.picture_play_audio));
            mTvMusicStatus.setText(getString(com.chavesgu.images_picker.R.string.picture_pause_audio));
        }
        playOrPause();
        if (!isPlayAudio) {
            mHandler.post(mRunnable);
    ...
    public void onItemClick(int position, boolean isCameraFolder, long bucketId, String
        ...
        long currentBucketId = ValueOf.toLong(mTvPictureTitle.getTag(com.chavesgu.images_picker.R.id.view_tag));
        mTvPictureTitle.setTag(com.chavesgu.images_picker.R.id.view_count_tag, folderWindow.getFolder(position) != null
        ...
        mTvPictureTitle.setTag(com.chavesgu.images_picker.R.id.view_tag, bucketId);
        folderWindow.dismiss();
    }
    ...
    private void setLastCacheFolderData() {
        int oldPosition = ValueOf.toInt(mTvPictureTitle.getTag(com.chavesgu.images_picker.R.id.view_index_tag));
    ...
    private boolean isCurrentCacheFolderData(int position) {
        mTvPictureTitle.setTag(com.chavesgu.images_picker.R.id.view_index_tag, position);
        ...
        if (config.isOriginalControl) {
            if (config.isDisplayOriginalSize) {
                ...
                if (totalSize > 0) {
                    ...
                    mCbOriginal.setText(getString(com.chavesgu.images_picker.R.string.picture_original_image, fileSize));
                } else {
                    mCbOriginal.setText(getString(com.chavesgu.images_picker.R.string.picture_default_original_image));
                }
            } else {
                 mCbOriginal.setText(getString(com.chavesgu.images_picker.R.string.picture_default_original_image));
            }
    ...
    public void startPreview(List<LocalMedia> previewData, int position) {
        ...
        if (PictureMimeType.isHasVideo(mimeType)) {
            ...
            bundle.putBoolean(PictureConfig.EXTRA_CHANGE_ORIGINAL, config.isCheckOriginalImage);
            bundle.putBoolean(PictureConfig.EXTRA_SHOW_CAMERA, mAdapter.isShowCamera());
            bundle.putLong(PictureConfig.EXTRA_BUCKET_ID, ValueOf.toLong(mTvPictureTitle.getTag(com.chavesgu.images_picker.R.id.view_tag)));
            bundle.putInt(PictureConfig.EXTRA_PAGE, mPage);
            bundle.putParcelable(PictureConfig.EXTRA_CONFIG, config);
            bundle.putInt(PictureConfig.EXTRA_DATA_COUNT, ValueOf.toInt(mTvPictureTitle.getTag(com.chavesgu.images_picker.R.id.view_count_tag)));
            bundle.putString(PictureConfig.EXTRA_IS_CURRENT_DIRECTORY, mTvPictureTitle.getText().toString());
            JumpUtils.startPicturePreviewActivity(getContext(), config.isWeChatStyle, bundle,
                    config.selectionMode == PictureConfig.SINGLE ? UCrop.REQUEST_CROP : UCrop.REQUEST_MULTI_CROP);
            overridePendingTransition(PictureSelectionConfig.windowAnimationStyle.activityPreviewEnterAnimation, com.chavesgu.images_picker.R.anim.picture_anim_fade_in);
        }
    }
        ...
        if (enable) {
            ...
            if (PictureSelectionConfig.uiStyle != null) {
                if (PictureSelectionConfig.uiStyle.picture_bottom_previewNormalText != 0) {
                    ...
                    mTvPicturePreview.setText(getString(com.chavesgu.images_picker.R.string.picture_preview_num, selectData.size()));
                }
            } else if (PictureSelectionConfig.style != null) {
            ...
            if (numComplete) {
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    ...
                    mTvPictureOk.setText(getString(com.chavesgu.images_picker.R.string.picture_completed));
                }
            ...
            if (PictureSelectionConfig.uiStyle != null) {
                if (PictureSelectionConfig.uiStyle.picture_bottom_previewDefaultText != 0) {
                    ...
                    mTvPicturePreview.setText(getString(com.chavesgu.images_picker.R.string.picture_preview));
                }
            ...
            if (numComplete) {
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    ...
                    mTvPictureOk.setText(getString(com.chavesgu.images_picker.R.string.picture_please_select));
                }
            }
        }
    }
    ...
    private void notifyAdapterData(LocalMedia media) {
        if (mAdapter != null) {
            ...
            if (folderWindow.getFolder(0) != null) {
                mTvPictureTitle.setTag(com.chavesgu.images_picker.R.id.view_count_tag, folderWindow.getFolder(0).getImageNum());
            }
            allFolderSize = 0;
        }
    }
        ...
        if (config.isWithVideoImage) {
            ...
            if (PictureMimeType.isHasVideo(media.getMimeType())) {
                if (config.maxVideoSelectNum <= 0) {
                    showPromptDialog(getString(com.chavesgu.images_picker.R.string.picture_rule));
                } else {
                    if (videoSize >= config.maxVideoSelectNum) {
                        showPromptDialog(getString(com.chavesgu.images_picker.R.string.picture_message_max_num, config.maxVideoSelectNum));
                    } else {
        ...
        if (PictureMimeType.isHasVideo(media.getMimeType())) {
            if (config.videoMinSecond > 0 && config.videoMaxSecond > 0) {
                ...
                if (media.getDuration() < config.videoMinSecond || media.getDuration() > config.videoMaxSecond) {
                    isEnterNext = false;
                    showPromptDialog(getString(com.chavesgu.images_picker.R.string.picture_choose_limit_seconds, config.videoMinSecond / 1000, config.videoMaxSecond / 1000));
                }
                ...
                if (media.getDuration() < config.videoMinSecond) {
                    isEnterNext = false;
                    showPromptDialog(getString(com.chavesgu.images_picker.R.string.picture_choose_min_seconds, config.videoMinSecond / 1000));
                }
            } else if (config.videoMaxSecond > 0) {
                // Only the maximum length of video is set
                if (media.getDuration() > config.videoMaxSecond) {
                    isEnterNext = false;
                    showPromptDialog(getString(com.chavesgu.images_picker.R.string.picture_choose_max_seconds, config.videoMaxSecond / 1000));
                }
            }
        }
        return isEnterNext;
        ...
        switch (requestCode) {
            case PictureConfig.APPLY_STORAGE_PERMISSIONS_CODE:
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    showPermissionsDialog(false, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE,
                            Manifest.permission.WRITE_EXTERNAL_STORAGE}, getString(com.chavesgu.images_picker.R.string.picture_jurisdiction));
                }
                break;
            case PictureConfig.APPLY_CAMERA_PERMISSIONS_CODE:
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    showPermissionsDialog(true, new String[]{Manifest.permission.CAMERA}, getString(com.chavesgu.images_picker.R.string.picture_camera));
                }
                break;
    ...
    protected void showPermissionsDialog(boolean isCamera, String[] permissions, String errorMsg) {
        ...
        PictureCustomDialog dialog = new PictureCustomDialog(getContext(), com.chavesgu.images_picker.R.layout.picture_wind_base_dialog);
        dialog.setCancelable(false);
        dialog.setCanceledOnTouchOutside(false);
        Button btn_cancel = dialog.findViewById(com.chavesgu.images_picker.R.id.btn_cancel);
        Button btn_commit = dialog.findViewById(com.chavesgu.images_picker.R.id.btn_commit);
        btn_commit.setText(getString(com.chavesgu.images_picker.R.string.picture_go_setting));
        TextView tvTitle = dialog.findViewById(com.chavesgu.images_picker.R.id.tvTitle);
        TextView tv_content = dialog.findViewById(com.chavesgu.images_picker.R.id.tv_content);
        tvTitle.setText(getString(com.chavesgu.images_picker.R.string.picture_prompt));
