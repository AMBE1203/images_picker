...
public class PictureSelectorCameraEmptyActivity extends PictureBaseActivity {
    ...
    public void immersive() {
        ImmersiveManage.immersiveAboveAPI23(this
                , ContextCompat.getColor(this, com.chavesgu.images_picker.R.color.picture_color_transparent)
                , ContextCompat.getColor(this, com.chavesgu.images_picker.R.color.picture_color_transparent)
                , openWhiteStatusBar);
    }
    ...
    public int getResourceId() {
        return com.chavesgu.images_picker.R.layout.picture_empty;
    }
        ...
        switch (requestCode) {
            ...
            case PictureConfig.APPLY_CAMERA_PERMISSIONS_CODE:
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    exit();
                    ToastUtils.s(getContext(), getString(com.chavesgu.images_picker.R.string.picture_camera));
                }
                break;
        }
    }
