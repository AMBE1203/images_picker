...
import com.chavesgu.images_picker.lib.adapter.PictureSimpleFragmentAdapter;
...
import com.chavesgu.images_picker.lib.model.LocalMediaPageLoader;
...
import com.chavesgu.images_picker.lib.tools.VoiceUtils;
...
public class PicturePreviewActivity extends PictureBaseActivity implements
    ...
    public int getResourceId() {
        return com.chavesgu.images_picker.R.layout.picture_preview;
    }
    ...
    protected void initWidgets() {
        ...
        pictureLeftBack = findViewById(com.chavesgu.images_picker.R.id.pictureLeftBack);
        ...
        viewPager = findViewById(com.chavesgu.images_picker.R.id.preview_pager);
        mPicturePreview = findViewById(com.chavesgu.images_picker.R.id.picture_id_preview);
        mPictureEditor = findViewById(com.chavesgu.images_picker.R.id.picture_id_editor);
        btnCheck = findViewById(com.chavesgu.images_picker.R.id.btnCheck);
        check = findViewById(com.chavesgu.images_picker.R.id.check);
        ...
        tvMediaNum = findViewById(com.chavesgu.images_picker.R.id.tv_media_num);
        selectBarLayout = findViewById(com.chavesgu.images_picker.R.id.select_bar_layout);
        mTvPictureOk.setOnClickListener(this);
        tvMediaNum.setOnClickListener(this);
        tvTitle = findViewById(com.chavesgu.images_picker.R.id.picture_title);
            ...
            if (startCount <= 0) {
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    ...
                    mTvPictureOk.setText(!TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                            ? PictureSelectionConfig.style.pictureUnCompleteText : getString(com.chavesgu.images_picker.R.string.picture_please_select));
                }
            } else {
                // 已选择
                if (PictureSelectionConfig.uiStyle != null) {
            ...
            if (startCount <= 0) {
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    mTvPictureOk.setText(PictureSelectionConfig.uiStyle.isCompleteReplaceNum && PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText != 0
                            ? String.format(getString(PictureSelectionConfig.uiStyle.picture_bottom_completeDefaultText), startCount, config.maxSelectNum) : getString(com.chavesgu.images_picker.R.string.picture_done_front_num,
                    ...
                    mTvPictureOk.setText(PictureSelectionConfig.style.isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                            ? PictureSelectionConfig.style.pictureUnCompleteText : getString(com.chavesgu.images_picker.R.string.picture_done_front_num,
                            startCount, config.maxSelectNum));
                }
            } else {
                // 已选择
        ...
        if (PictureSelectionConfig.uiStyle != null) {
            ...
            if (config.isOriginalControl) {
                ...
                if (PictureSelectionConfig.uiStyle.picture_bottom_originalPictureTextColor != 0) {
                    ...
                    mCbOriginal.setTextColor(ContextCompat.getColor(this, com.chavesgu.images_picker.R.color.picture_color_53575e));
                }
            ...
            Drawable pictureCheckedStyle = AttrsUtils.getTypeValueDrawable(getContext(), com.chavesgu.images_picker.R.attr.picture_checked_style, com.chavesgu.images_picker.R.drawable.picture_checkbox_selector);
            check.setBackground(pictureCheckedStyle);
            ColorStateList completeColorStateList = AttrsUtils.getTypeValueColorStateList(getContext(), com.chavesgu.images_picker.R.attr.picture_ac_preview_complete_textColor);
            if (completeColorStateList != null) {
                mTvPictureOk.setTextColor(completeColorStateList);
            }
            Drawable leftDrawable = AttrsUtils.getTypeValueDrawable(getContext(), com.chavesgu.images_picker.R.attr.picture_preview_leftBack_icon, com.chavesgu.images_picker.R.drawable.picture_icon_back);
            pictureLeftBack.setImageDrawable(leftDrawable);

            int titleColor = AttrsUtils.getTypeValueColor(getContext(), com.chavesgu.images_picker.R.attr.picture_ac_preview_title_textColor);
            if (titleColor != 0) {
            ...
            int previewBottomBgColor = AttrsUtils.getTypeValueColor(getContext(), com.chavesgu.images_picker.R.attr.picture_ac_preview_bottom_bg);
    ...
    private void setTitle() {
        if (config.isPageStrategy && !isBottomPreview && !config.isOnlySandboxDir) {
            tvTitle.setText(getString(com.chavesgu.images_picker.R.string.picture_preview_image_num,
        ...
        if (enable) {
            ...
            if (PictureSelectionConfig.style != null) {
                if (PictureSelectionConfig.style.pictureCompleteTextColor != 0) {
                    ...
                    mTvPictureOk.setTextColor(ContextCompat.getColor(getContext(), com.chavesgu.images_picker.R.color.picture_color_fa632d));
                }
            }
            if (numComplete) {
            ...
            if (PictureSelectionConfig.style != null) {
                if (PictureSelectionConfig.style.pictureUnCompleteTextColor != 0) {
                    ...
                    mTvPictureOk.setTextColor(ContextCompat.getColor(getContext(), com.chavesgu.images_picker.R.color.picture_color_9b));
                }
            }
            if (numComplete) {
                initCompleteText(0);
    ...
    public void onClick(View view) {
        ...
        if (id == com.chavesgu.images_picker.R.id.pictureLeftBack) {
            onBackPressed();
        } else if (id == com.chavesgu.images_picker.R.id.picture_tv_ok || id == com.chavesgu.images_picker.R.id.tv_media_num) {
            onComplete();
        } else if (id == com.chavesgu.images_picker.R.id.btnCheck) {
            onCheckedComplete();
        } else if (id == com.chavesgu.images_picker.R.id.picture_id_editor) {
            onEditorImage();
        }
    }
            ...
            if (config.isWithVideoImage) {
                ...
                if (PictureMimeType.isHasVideo(image.getMimeType())) {
                    ...
                    if (currentSize >= config.maxSelectNum && !check.isSelected()) {
                        showPromptDialog(getString(com.chavesgu.images_picker.R.string.picture_message_max_num, config.maxSelectNum));
                        return;
                    }
                    ...
                    if (!check.isSelected() && config.videoMinSecond > 0 && image.getDuration() < config.videoMinSecond) {
                        // 视频小于最低指定的长度
                        showPromptDialog(getContext().getString(com.chavesgu.images_picker.R.string.picture_choose_min_seconds, config.videoMinSecond / 1000));
                        return;
                    }

                    if (!check.isSelected() && config.videoMaxSecond > 0 && image.getDuration() > config.videoMaxSecond) {
                        // 视频时长超过了指定的长度
                        showPromptDialog(getContext().getString(com.chavesgu.images_picker.R.string.picture_choose_max_seconds, config.videoMaxSecond / 1000));
                        return;
                    }
                } else {
                    if (currentSize >= config.maxSelectNum && !check.isSelected()) {
