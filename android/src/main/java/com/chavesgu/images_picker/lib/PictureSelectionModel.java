...
import com.chavesgu.images_picker.lib.engine.CompressEngine;
import com.chavesgu.images_picker.lib.engine.ImageEngine;
import com.chavesgu.images_picker.lib.entity.LocalMedia;
import com.chavesgu.images_picker.lib.listener.OnChooseLimitCallback;
import com.chavesgu.images_picker.lib.listener.OnCustomCameraInterfaceListener;
import com.chavesgu.images_picker.lib.listener.OnCustomImagePreviewCallback;
import com.chavesgu.images_picker.lib.listener.OnPermissionsObtainCallback;
import com.chavesgu.images_picker.lib.listener.OnResultCallbackListener;
import com.chavesgu.images_picker.lib.listener.OnVideoSelectedPlayCallback;
import com.chavesgu.images_picker.lib.style.PictureCropParameterStyle;
import com.chavesgu.images_picker.lib.style.PictureParameterStyle;
import com.chavesgu.images_picker.lib.style.PictureSelectorUIStyle;
import com.chavesgu.images_picker.lib.style.PictureWindowAnimationStyle;
...
public class PictureSelectionModel {
     ...
     * Use {@link com.chavesgu.images_picker.R.style#picture_default_style#picture_Sina_style#picture_white_style#picture_QQ_style#picture_WeChat_style}
     */
    ...
    public void forResult(int requestCode) {
        if (!DoubleUtils.isFastDoubleClick()) {
            ...
            activity.overridePendingTransition(windowAnimationStyle.activityEnterAnimation, com.chavesgu.images_picker.R.anim.picture_anim_fade_in);
        }
    }
    ...
    public void forResult(OnResultCallbackListener<LocalMedia> listener) {
        if (!DoubleUtils.isFastDoubleClick()) {
            ...
            activity.overridePendingTransition(
                    windowAnimationStyle.activityEnterAnimation, com.chavesgu.images_picker.R.anim.picture_anim_fade_in);
        }
    }
