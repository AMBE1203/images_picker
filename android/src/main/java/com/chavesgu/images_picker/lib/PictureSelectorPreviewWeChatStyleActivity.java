...
import com.chavesgu.images_picker.lib.adapter.PictureWeChatPreviewGalleryAdapter;
...
import com.chavesgu.images_picker.lib.decoration.WrapContentLinearLayoutManager;
...
public class PictureSelectorPreviewWeChatStyleActivity extends PicturePreviewActivity {
    ...
    public int getResourceId() {
        return com.chavesgu.images_picker.R.layout.picture_wechat_style_preview;
    }
    ...
    protected void initWidgets() {
        super.initWidgets();
        goneParent();
        mRvGallery = findViewById(com.chavesgu.images_picker.R.id.rv_gallery);
        bottomLine = findViewById(com.chavesgu.images_picker.R.id.bottomLine);
        ...
        mTvSelected = findViewById(com.chavesgu.images_picker.R.id.tv_selected);
    ...
    private boolean isEqualsDirectory(String parentFolderName, String currentDirectory) {
        return isBottomPreview
                ...
                || currentDirectory.equals(getString(com.chavesgu.images_picker.R.string.picture_camera_roll))
    ...
    public void initPictureSelectorStyle() {
        ...
        if (PictureSelectionConfig.uiStyle != null) {
            ...
            if (PictureSelectionConfig.uiStyle.picture_bottom_barBackgroundColor != 0) {
                ...
                selectBarLayout.setBackgroundColor(ContextCompat.getColor(getContext(), com.chavesgu.images_picker.R.color.picture_color_half_grey));
            }
            ...
            if (PictureSelectionConfig.uiStyle.picture_bottom_selectedCheckStyle != 0) {
                ...
                check.setBackgroundResource(com.chavesgu.images_picker.R.drawable.picture_wechat_select_cb);
            }
            ...
            if (PictureSelectionConfig.uiStyle.picture_top_leftBack != 0) {
                ...
                pictureLeftBack.setImageResource(com.chavesgu.images_picker.R.drawable.picture_icon_back);
            }
            ...
            if (config.isOriginalControl) {
                ...
                if (PictureSelectionConfig.uiStyle.picture_bottom_originalPictureCheckStyle != 0) {
                    ...
                    mCbOriginal.setButtonDrawable(com.chavesgu.images_picker.R.drawable.picture_original_wechat_checkbox);
                }
            }
        ...
        if (config.isWithVideoImage) {
            ...
            if (config.selectionMode == PictureConfig.SINGLE) {
                ...
                if (isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)) {
                    ...
                    mTvPictureRight.setText(isNotEmptyStyle && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                            ? PictureSelectionConfig.style.pictureUnCompleteText : getString(com.chavesgu.images_picker.R.string.picture_send_num, selectData.size(),
                            config.maxSelectNum));
                }
            }
        } else {
            ...
            if (config.selectionMode == PictureConfig.SINGLE) {
                ...
                if (isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)) {
                    ...
                    mTvPictureRight.setText(isNotEmptyStyle && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                            ...
                            : getString(com.chavesgu.images_picker.R.string.picture_send_num, selectData.size(), maxSize));
                }
            }
        }
    }
