        ...
        if (!DoubleUtils.isFastDoubleClick()) {
            if (getActivity() != null) {
                ...
                getActivity().overridePendingTransition(enterAnimation != 0
                        ? enterAnimation : com.chavesgu.images_picker.R.anim.picture_anim_enter, com.chavesgu.images_picker.R.anim.picture_anim_fade_in);
            } else {
    ...
    public void externalPictureAudio(String path) {
        if (!DoubleUtils.isFastDoubleClick()) {
            if (getActivity() != null) {
                ...
                getActivity().startActivity(intent);
                getActivity().overridePendingTransition(com.chavesgu.images_picker.R.anim.picture_anim_enter, 0);
            } else {
                throw new NullPointerException("Starting the PictureSelector Activity cannot be empty ");
            }
        }
