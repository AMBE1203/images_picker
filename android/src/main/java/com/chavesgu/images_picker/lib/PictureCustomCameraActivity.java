...
import com.chavesgu.images_picker.lib.camera.CustomCameraType;
import com.chavesgu.images_picker.lib.camera.CustomCameraView;
import com.chavesgu.images_picker.lib.camera.listener.CameraListener;
import com.chavesgu.images_picker.lib.camera.listener.ClickListener;
...
public class PictureCustomCameraActivity extends PictureSelectorCameraEmptyActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.chavesgu.images_picker.R.layout.picture_custom_camera);
        mCameraView = findViewById(com.chavesgu.images_picker.R.id.cameraView);
        initView();
        requestCamera();
    }
        ...
        if (isEnterSetting) {
            if (PermissionChecker.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                if (PermissionChecker.checkSelfPermission(this, Manifest.permission.CAMERA)) {
                    ...
                    showPermissionsDialog(false, new String[]{Manifest.permission.CAMERA}, getString(com.chavesgu.images_picker.R.string.picture_camera));
                }
            } else {
        ...
        switch (requestCode) {
            case PictureConfig.APPLY_STORAGE_PERMISSIONS_CODE:
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    showPermissionsDialog(true, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, getString(com.chavesgu.images_picker.R.string.picture_jurisdiction));
                }
                break;
            ...
            case PictureConfig.APPLY_RECORD_AUDIO_PERMISSIONS_CODE:
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    showPermissionsDialog(false, new String[]{Manifest.permission.RECORD_AUDIO}, getString(com.chavesgu.images_picker.R.string.picture_audio));
                }
                break;
        }
    }
