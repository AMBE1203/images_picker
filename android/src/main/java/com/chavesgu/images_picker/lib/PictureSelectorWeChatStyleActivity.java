...
public class PictureSelectorWeChatStyleActivity extends PictureSelectorActivity {
    ...
    public int getResourceId() {
        return com.chavesgu.images_picker.R.layout.picture_wechat_style_selector;
    }

    @Override
    protected void initWidgets() {
        super.initWidgets();
        rlAlbum = findViewById(com.chavesgu.images_picker.R.id.rlAlbum);
        mTvPictureRight.setOnClickListener(this);
        mTvPictureRight.setText(getString(com.chavesgu.images_picker.R.string.picture_send));
    ...
    public void initPictureSelectorStyle() {
        if (PictureSelectionConfig.uiStyle != null) {
            if (PictureSelectionConfig.uiStyle.picture_top_titleRightTextDefaultBackground != 0) {
                ...
                mTvPictureRight.setBackgroundResource(com.chavesgu.images_picker.R.drawable.picture_send_button_default_bg);
            }
            if (PictureSelectionConfig.uiStyle.picture_bottom_barBackgroundColor != 0) {
                ...
                mBottomLayout.setBackgroundColor(ContextCompat.getColor(getContext(), com.chavesgu.images_picker.R.color.picture_color_grey));
            }
            if (PictureSelectionConfig.uiStyle.picture_top_titleRightTextColor.length > 0) {
                ...
                mTvPictureRight.setTextColor(ContextCompat.getColor(getContext(), com.chavesgu.images_picker.R.color.picture_color_53575e));
            }
            ...
            if (PictureSelectionConfig.uiStyle.picture_top_titleAlbumBackground != 0) {
                ...
                rlAlbum.setBackgroundResource(com.chavesgu.images_picker.R.drawable.picture_album_bg);
            }
            ...
            if (PictureSelectionConfig.style.pictureOriginalFontColor == 0) {
                mCbOriginal.setTextColor(ContextCompat
                        .getColor(this, com.chavesgu.images_picker.R.color.picture_color_white));
            }
            if (config.isOriginalControl) {
                if (PictureSelectionConfig.style.pictureOriginalControlStyle == 0) {
                    mCbOriginal.setButtonDrawable(ContextCompat
                            .getDrawable(this, com.chavesgu.images_picker.R.drawable.picture_original_wechat_checkbox));
                }
            }
            ...
            mBottomLayout.setBackgroundColor(pictureBottomBgColor != 0
                    ? pictureBottomBgColor : ContextCompat.getColor(getContext(), com.chavesgu.images_picker.R.color.picture_color_grey));

            mCbOriginal.setTextColor(ContextCompat
                    .getColor(this, com.chavesgu.images_picker.R.color.picture_color_white));
            Drawable drawable = ContextCompat.getDrawable(this, com.chavesgu.images_picker.R.drawable.picture_icon_wechat_down);
    ...
    private void setAlbumLayoutParams(boolean isHorizontal){
        if (rlAlbum.getLayoutParams() instanceof RelativeLayout.LayoutParams) {
            ...
            if (isHorizontal) {
                ...
                lp.addRule(RelativeLayout.RIGHT_OF, com.chavesgu.images_picker.R.id.pictureLeftBack);
            }
        }
    }
        ...
        if (enable) {
            ...
            if (PictureSelectionConfig.uiStyle != null) {
                if (PictureSelectionConfig.uiStyle.picture_top_titleRightTextNormalBackground != 0) {
                    ...
                    mTvPictureRight.setBackgroundResource(com.chavesgu.images_picker.R.drawable.picture_send_button_bg);
                }
                if (PictureSelectionConfig.uiStyle.picture_bottom_previewTextColor.length > 0) {
                    ...
                    mTvPicturePreview.setTextColor(ContextCompat.getColor(getContext(), com.chavesgu.images_picker.R.color.picture_color_white));
                }
                if (PictureSelectionConfig.uiStyle.picture_bottom_previewNormalText !=0) {
                    ...
                    mTvPicturePreview.setText(getString(com.chavesgu.images_picker.R.string.picture_preview_num, size));
                }
            } else if (PictureSelectionConfig.style != null) {
                ...
                if (PictureSelectionConfig.style.pictureCompleteTextColor != 0) {
                    ...
                    mTvPictureRight.setTextColor(ContextCompat.getColor(getContext(), com.chavesgu.images_picker.R.color.picture_color_white));
                }
            ...
            if (PictureSelectionConfig.uiStyle != null) {
                ...
                if (PictureSelectionConfig.style.pictureUnPreviewTextColor != 0) {
                    ...
                    mTvPicturePreview.setTextColor(ContextCompat.getColor(getContext(), com.chavesgu.images_picker.R.color.picture_color_9b));
                }
                if (!TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)) {
                    mTvPictureRight.setText(PictureSelectionConfig.style.pictureUnCompleteText);
                } else {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == com.chavesgu.images_picker.R.id.picture_right) {
        ...
        if (config.isWithVideoImage) {
            if (config.selectionMode == PictureConfig.SINGLE) {
                if (size <= 0) {
                    mTvPictureRight.setText(isNotEmptyStyle && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                            ? PictureSelectionConfig.style.pictureUnCompleteText : getString(com.chavesgu.images_picker.R.string.picture_send));
                } else {
                    ...
                    if (isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)) {
                        ...
                        mTvPictureRight.setText(isNotEmptyStyle && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)
                                ? PictureSelectionConfig.style.pictureCompleteText : getString(com.chavesgu.images_picker.R.string.picture_send));
                    }
                }
            } else {
                boolean isCompleteReplaceNum = isNotEmptyStyle && PictureSelectionConfig.style.isCompleteReplaceNum;
                if (isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)) {
                    ...
                    mTvPictureRight.setText(isNotEmptyStyle && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                            ? PictureSelectionConfig.style.pictureUnCompleteText : getString(com.chavesgu.images_picker.R.string.picture_send_num, size, config.maxSelectNum));
                }
            }
        } else {
            ...
            if (config.selectionMode == PictureConfig.SINGLE) {
                ...
                if (isCompleteReplaceNum && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureCompleteText)) {
                    ...
                    mTvPictureRight.setText(isNotEmptyStyle && !TextUtils.isEmpty(PictureSelectionConfig.style.pictureUnCompleteText)
                            ? PictureSelectionConfig.style.pictureUnCompleteText : getString(com.chavesgu.images_picker.R.string.picture_send_num, size, maxSize));
                }
            }
        }
    }
