...
public class PictureVideoPlayActivity extends PictureBaseActivity implements
    ...
    public int getResourceId() {
        return com.chavesgu.images_picker.R.layout.picture_activity_video_play;
    }
    ...
    protected void initWidgets() {
        ...
        ibLeftBack = findViewById(com.chavesgu.images_picker.R.id.pictureLeftBack);
        mVideoView = findViewById(com.chavesgu.images_picker.R.id.video_view);
        TextView tvConfirm = findViewById(com.chavesgu.images_picker.R.id.tv_confirm);
        mVideoView.setBackgroundColor(Color.BLACK);
        iv_play = findViewById(com.chavesgu.images_picker.R.id.iv_play);
    ...
    public void onClick(View v) {
        ...
        if (id == com.chavesgu.images_picker.R.id.pictureLeftBack) {
            onBackPressed();
        } else if (id == com.chavesgu.images_picker.R.id.iv_play) {
            mVideoView.start();
            iv_play.setVisibility(View.INVISIBLE);
        } else if (id == com.chavesgu.images_picker.R.id.tv_confirm) {
